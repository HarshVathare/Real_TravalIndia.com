...
<body>
 ...
 <div id="home" class="contener">
    <div class="nevbar"><img src="/images/logo.png" alt="" width="100px" height="65px">
      ...
      <div class="lo-re">
        <ul>
        <li ><button id="b1"><a href="login.php" class="a_login">Login</a></button></li>
         <li ><button id="b2"><a href="register.php" class="a_register">Sign up</a></button></li>
         </ul>
      </div>  
    </div>
 </div>
      ...
      <div  class="wrapper">
        <p>Taj Mahal , Agra</p>
         ...
         <div class="parent">
          ...
          <button ><a href="login.php">Explore</a></button>
          <div id="contact"></div>
        </div >
